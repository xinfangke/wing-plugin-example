...
var webviewrunNode:any;
var webviewrunEDNUrl:string = 'http://edn.egret.com/cn/example/page/examples/1/';
var webviewrunTimeId=0;

wing.webview.ipc.on("EventSelectItem",function(event:any,node:any){
    webviewrunNode=node;
...
function openProject(systemPath:string){
    hideLoading();
